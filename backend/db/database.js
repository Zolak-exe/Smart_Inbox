...
function initDb() {
  db.serialize(() => {
    ...
    const defaultAccounts = [
      { email: 'clement.noel.28@proton.me', host: '127.0.0.1', port: '1143', user: 'clement.noel.28@proton.me', password: 'PLACEHOLDER_PASSWORD', tls: 'false' },
      { email: 'chagamings@gmail.com', host: 'imap.gmail.com', port: '993', user: 'chagamings@gmail.com', password: 'PLACEHOLDER_PASSWORD', tls: 'true' },
      { email: '28.clement.noel@gmail.com', host: 'imap.gmail.com', port: '993', user: '28.clement.noel@gmail.com', password: 'PLACEHOLDER_PASSWORD', tls: 'true' },
      { email: 'clement.noel.alternance@proton.me', host: '127.0.0.1', port: '1143', user: 'clement.noel.alternance@proton.me', password: 'PLACEHOLDER_PASSWORD', tls: 'false' }
    ];
